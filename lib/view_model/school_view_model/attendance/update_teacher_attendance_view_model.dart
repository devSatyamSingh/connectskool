...
import 'package:school_pro/repo/school_repo/attendance/update_teacher_attendance_repo.dart';
...
class UpdateTeacherAttendanceViewModel with ChangeNotifier {
  final _loginRepo = UpdateTeacherAttendanceRepository();
  bool _loading = false;
  ...
  Future<bool> updateTeacherAttendanceApi(
    ...
    try {
      final response = await _loginRepo.updateTeacherAttendanceApi(data);
