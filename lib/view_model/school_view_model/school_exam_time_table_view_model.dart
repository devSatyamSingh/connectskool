...
import '../../model/school_model/get_school_exam_time_table_model.dart'; // ExamTimeTableModel
import '../../repo/school_repo/exam_time_table_repo.dart';
...
class SchoolExamTimeTableViewModel extends ChangeNotifier {
  ...
  ExamTimeTableModel? _examTimeTableModel;  // ✅ TimetableModel → ExamTimeTableModel
  bool _loading = false;
  String? _error;
