...
import 'package:school_pro/repo/school_repo/classes/delete_class_repo.dart';
import 'package:school_pro/repo/school_repo/exam/delete_exam_repo.dart';
import 'package:school_pro/repo/school_repo/timetable/delete_exam_time_table_repo.dart';
...
class DeleteExamTimeTableViewModel with ChangeNotifier {
  final _repo = DeleteExamTimeTableRepository();
  ...
  Future<bool> deleteExamTimeTableApi(
      dynamic timetableId,
    ...
    try {
      ...
      final response = await _repo.deleteExamTimeTableApi(data);
      ...
      if (statusCode == 200 || statusCode == 201) {
        Utils.show(message ?? "Exam deleted successfully", context);
