...
import '../view_model/school_view_model/collect_fee_payment_view_model.dart';
    ...
    return Expanded(
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(subtitle,
              style:
              TextStyle(fontSize: 10, color: accentColor.withOpacity(0.6))),
        ]),
      ),
    );
  }
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("Student Fee Profile",
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 20,
                            fontWeight: FontWeight.bold)),
                    Text("Fee details & payment history",
                        style: TextStyle(
              ...
              Padding(
                ...
                child: Row(children: [
                  _summaryCard(
                      ...
                      amount: '₹$pending',
                      subtitle:
                      pending > 0 ? 'Next due: Soon' : 'All clear!',
                  ...
                  _summaryCard(
                      ...
                      amount: '₹$fine',
                      subtitle:
                      fine > 0 ? 'Fine applicable' : 'No fines',
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text("${feeList.length} items",
                                    style: TextStyle(
                                        fontSize: 11,
                                      ...
                                      if (!isPaid && feePending > 0)
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () => _showCollectPaymentSheet(fee),
                                              child: Container(
                                                padding: const EdgeInsets.symmetric(
                                            ...
                                            // ✅ Discontinue button
                                            GestureDetector(
                                              onTap: () => _showDiscontinueDialog(context, fee),
                                              child: Container(
                                                padding: const EdgeInsets.symmetric(
                                                    horizontal: 12, vertical: 7),
                                                decoration: BoxDecoration(
...
class _CollectPaymentSheetState extends State<_CollectPaymentSheet> {
  ...
  bool _validateForm() {
    ...
    if (isReferenceRequired && _referenceNoController.text.trim().isEmpty) {
      setState(() {
        _referenceError = 'Reference number is required for ${_paymentMode} payment';
      });
      return false;
    }
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                        borderSide: const BorderSide(color: AppColor.lightBlueColor),
                      ),
                    ),
                  ),
                ],
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12),
                          borderSide: BorderSide(color: _referenceError != null ? Colors.red.shade300 : Colors.grey.shade300),
                        ),
                        enabledBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12),
                          borderSide: BorderSide(color: _referenceError != null ? Colors.red.shade300 : Colors.grey.shade300),
                        ...
                        focusedBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12),
                          borderSide: BorderSide(color: _referenceError != null ? Colors.red.shade400 : AppColor.lightBlueColor),
                        ),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(children: [
                ...
                const SizedBox(width: 12),
                const Expanded(
                  child: Text('Discontinue Fee Service',
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('FEE HEAD', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Colors.grey.shade500, letterSpacing: 0.8)),
                    const SizedBox(height: 6),
                    Container(
                      width: double.infinity,
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('FINANCIAL BALANCE', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Colors.grey.shade500, letterSpacing: 0.8)),
                    const SizedBox(height: 6),
                    Container(
                      ...
                      child: Row(children: [
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('Paid', style: TextStyle(fontSize: 11, color: Colors.grey.shade500)),
                          const SizedBox(height: 2),
                          Text('₹$paidAmt', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.green.shade600)),
                        ])),
                        Container(width: 1, height: 30, color: Colors.grey.shade300),
                        const SizedBox(width: 10),
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('Pending:', style: TextStyle(fontSize: 11, color: Colors.grey.shade500)),
                          const SizedBox(height: 2),
                          Text('₹$pendingAmt', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.red.shade500)),
                        ])),
                      ]),
                    ),
                  ]),
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Row(children: [
                      Text('DISCONTINUE DATE', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Colors.grey.shade500, letterSpacing: 0.8)),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          Expanded(child: Text(DateFormat('MM/dd/yyyy').format(_selectedDate), style: const TextStyle(fontSize: 13))),
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Row(children: [
                      Text('REASON', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Colors.grey.shade500, letterSpacing: 0.8)),
                      const SizedBox(width: 3),
                      Text('*', style: TextStyle(color: Colors.red.shade400, fontWeight: FontWeight.bold)),
                    ]),
                    const SizedBox(height: 6),
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          isExpanded: true,
                          hint: Text('Select reason...', style: TextStyle(fontSize: 13, color: Colors.grey.shade500)),
              ...
              RichText(text: TextSpan(children: [
                TextSpan(text: 'ADDITIONAL NOTES', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Colors.grey.shade500, letterSpacing: 0.8)),
                TextSpan(text: '  (Optional)', style: TextStyle(fontSize: 11, color: Colors.grey.shade400)),
              ])),
              const SizedBox(height: 6),
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: Colors.orange.shade300)),
                ),
              ),
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      final success = await Provider.of<DiscontinueStudentViewModel>(
                        context,
                        listen: false,
                      ).discontinueStudentApi(
                        widget.studentId,                                    // ✅ student_id
                        widget.academicYear,                                 // ✅ academic_year
                        DateFormat('yyyy-MM-dd').format(_selectedDate),      // ✅ discontinued_on
                    ...
                    child: Consumer<DiscontinueStudentViewModel>(
                      builder: (_, vm, __) => vm.loading
                          ...
                          child: CircularProgressIndicator(
                              color: Colors.white, strokeWidth: 2))
                          : const Text('Confirm Discontinuation',
                          style: TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.bold,
                              color: Colors.white)),
