...
import 'package:school_pro/model/school_model/attendance/all_attendance_model.dart';
...
class AllAttendanceRepository {
  ...
  Future<AllAttendanceModel> getAttendance({
    ...
    final url = "${ApiUrl.studentAttendance}?class_id=$classId&section_id=$sectionId&date=$date";
